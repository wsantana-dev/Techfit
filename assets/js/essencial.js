...
if (cadastroForm && popup && mensagemPopup && fecharPopup) {
    cadastroForm.addEventListener("submit", function(e) {
        ...
        mensagemPopup.innerHTML = "Parabéns! Você está inscrito no Plano Essencial 😊💪. Agora entraremos em contato pelo seu e-mail para conectar você a uma TechFit mais próxima e realizar sua digital.";
